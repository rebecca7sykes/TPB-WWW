...
return;
	...
	require_once( INC_DIR . 'classes/connection.php' );//8
	require_once( INC_DIR . 'classes/messageQueue.php' );//8.5
	require_once( INC_DIR . 'classes/message.php' );//9
	require_once( INC_DIR . 'classes/chatServer.php' );//9.5
	require_once( INC_DIR . 'classes/functions_utils.php' );//10
	$GLOBALS['fc_config']['languages'] = array();//14-17
