...
(
	...
	"messages"    => "CREATE TABLE {dbpref}messages (id int(11) NOT NULL auto_increment, created timestamp(14) NOT NULL, toconnid varchar(32) default NULL, touserid int(11) default NULL, toroomid int(11) default NULL, command varchar(255) NOT NULL default '', userid int(11) default NULL, roomid int(11) default NULL, txt varchar(255), chatid int(11) NOT NULL default '1', instance_id int(11) default 1, INDEX(touserid), INDEX(toroomid), INDEX(toconnid), INDEX(created), PRIMARY KEY (id)) TYPE=MEMORY;",
	...
	"users"       => "CREATE TABLE {dbpref}users (id int(11) NOT NULL auto_increment, login varchar(200) NOT NULL default '', password varchar(32) NOT NULL default '', roles int(11) NOT NULL default '0', profile varchar(255) default NULL, instance_id int(11) default 1, INDEX(login), PRIMARY KEY  (id)) TYPE=MEMORY;",
