<?php /* Smarty version 2.6.10, created on 2011-02-28 23:02:02
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'index.tpl', 236, false),)), $this); ?>
<html>
<head>
...
"<?php if ($this->_tpl_vars['val']['is_default'] == 1): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['val']['name']; ?>
		  ...
		  <?php endif; ?>
		   <tr>
            ...
            <td><select name="room">
                <?php $this->assign('selected', $this->_tpl_vars['data']['defaultRoom']); ?>
				<?php $_from = $this->_tpl_vars['data']['rooms']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['ordersel']):
?>
					<option value="<?php echo $this->_tpl_vars['key']+1; ?>
"<?php if ($this->_tpl_vars['key']+1 == $this->_tpl_vars['selected']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['ordersel']['name']; ?>
</option>
				<?php endforeach; endif; unset($_from); ?>
              </select>
				</td>
